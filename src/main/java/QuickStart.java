...
public class QuickStart {
    public static void main(String[] args) throws IOException {
        ...
        try (MongoClient mongoClient = MongoClients.create(p.getProperty("connStr"))) {
            ...
            System.out.println("Amount of unique genres: " + f.countUnique(movieList, genres));
            ...
            System.out.println("Amount of unique languages: " + f.countUnique(movieList, languages));
